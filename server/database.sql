...
(name, role, position_hierarchy, department, member_type, image, linkedin, github, twitter, email, bio)
VALUES
-- Super Core
...
-- Core Members - Digital Creatives
...
-- Core Members - Photography
('John Smith', 'Head of Photography', 'Head', 'Photography', 'core', '/team/john-smith.jpg', 'https://linkedin.com/in/johnsmith', 'https://github.com/johnsmith', 'https://twitter.com/johnsmith', 'john.smith@iet.edu', 'Capturing moments and documenting events. Skilled photographer with a creative eye.'),
('Emma Wilson', 'Subhead of Photography', 'Subhead', 'Photography', 'core', '/team/emma-wilson.jpg', 'https://linkedin.com/in/emmawilson', 'https://github.com/emmawilson', 'https://twitter.com/emmawilson', 'emma.wilson@iet.edu', 'Assisting in event photography and editing. Passionate about visual storytelling.');
-- Create events table
